...
export const Home = () => {
  ...
  return (
    <div className="w-screen h-screen border-pink-900" style={styles.container}>
      <div className="w-[514px] h-[326px] top-[252px]  left-[200px] relative flex flex-col justify-between scale-[1.3]">
        <div>
          <p className="font-[Work_Sans] font-normal text-[48px] leading-[56px] text-white">
            Instant <br />
            collaborations for <br />
            remote teams
          </p>
          <p className="font-[Mulish] text-[18px] text-white font-bold">
        ...
        <div>
          <input
            ...
            placeholder="Email"
          />
          <button className="w-[163px] h-[56px] bg-[#0BBEF2] rounded-[5px] ml-[13.8px] text-white">
            Get early access
          </button>
        </div>
      </div>
