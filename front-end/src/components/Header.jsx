...
return(
   ...
   <div className=" text-black ml-[30px] h-fit text-mt font-extral">team
   ...
   <div className="flex ml-[790px] flex-row items-center gap-8 ">
    ...
    <button className="h-full px-5 py-2 border-[4px] opacity-70 rounded w-fit">Get access</button>
   </div>
